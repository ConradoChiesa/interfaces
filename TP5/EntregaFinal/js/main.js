...
function load() {
  mostrarLogin();
      ...
      function mostrarLogin(){
        fetch("html/login.html", {cache: "no-cache"}).then(
          function(response){
            response.text().then(
          function(texto){
      ...
      function mostrarNav() {
        fetch("html/navbar.html", {cache: "no-cache"}).then(
          function(response){
            response.text().then(
          function(texto){
        ...
        function mostrarHome(){
          fetch("html/home.html", {cache: "no-cache"}).then(
            function(response){
              response.text().then(
            function(texto){
              document.querySelector("#main-section").innerHTML = texto;
        ...
        function mostrarAyuda(){
          fetch("html/ayuda.html", {cache: "no-cache"}).then(
            function(response){
              response.text().then(
            function(texto){
              document.querySelector("#main-section").innerHTML = texto;
        ...
        function mostrarPelicula() {
          fetch("html/pelicula.html", {cache: "no-cache"}).then(
            function(response){
              response.text().then(
                function(texto){
                  document.querySelector("#main-section").innerHTML = texto;
      ...
      function mostrarPelis() {
        fetch("html/peliculas.html", {cache: "no-cache"}).then(
          function(response){
            response.text().then(
              function(texto){
                document.querySelector("#main-section").innerHTML = texto;
      ...
      function mostrarCuenta() {
        fetch("html/miCuenta.html", {cache: "no-cache"}).then(
          function(response){
            response.text().then(
              function(texto){
                document.querySelector("#main-section").innerHTML = texto;
      ...
      function mostrarSerie() {
        fetch("html/serie.html", {cache: "no-cache"}).then(
          function(response){
            response.text().then(
              function(texto){
                document.querySelector("#main-section").innerHTML = texto;
      ...
      function mostrarResultados() {
        fetch("html/resultados.html", {cache: "no-cache"}).then(
          function(response){
            response.text().then(
              function(texto){
                document.querySelector("#main-section").innerHTML = texto;
      ...
      function mostrarSeries() {
        fetch("html/series.html", {cache: "no-cache"}).then(
          function(response){
            response.text().then(
              function(texto){
                document.querySelector("#main-section").innerHTML = texto;
    ...
    function mostrarPlanes() {
        fetch("html/planes.html", {cache: "no-cache"}).then(
          function(response){
            response.text().then(
              function(texto){
                document.querySelector("#main-section").innerHTML = texto;
    ...
    function mostrarMiLista() {
      fetch("html/miLista.html", {cache: "no-cache"}).then(
        function(response){
          response.text().then(
            function(texto){
              document.querySelector("#main-section").innerHTML = texto;
